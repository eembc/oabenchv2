...
AS		= $(TOOLS)/bin/powerpc-eabi-as

LD		= $(TOOLS)/bin/powerpc-eabi-gcc
EXEOUT	= -o
EXE		= .exe

AR		= $(TOOLS)/bin/powerpc-eabi-ar
LIBTYPE	= .a
LIBOUT	= 
...
AUTOCONF_DEFINES = \
	...
	$(CDEFN)HAVE_STRUCT_STAT_ST_BLKCNT=0

COMPILER_FLAGS	= -O2    -msim -mbig -mcpu=440 $(CDEFN)NDEBUG $(AUTOCONF_DEFINES)
COMPILER_NOOPT	= -O0    -msim -mbig -mcpu=440 $(CDEFN)NDEBUG $(AUTOCONF_DEFINES)
COMPILER_DEBUG	= -O0 -g -msim -mbig -mcpu=440 $(AUTOCONF_DEFINES)
...
# SIZE SECTION
SIZE	= $(TOOLS)/bin/powerpc-eabi-size
SIZE_FLAGS		= 
AWKSZ			= gcc
AWKDIR			= awk
...
RUN				= $(TCDIR)/gdb.sh powerpc-eabi-gdb
endif
endif
