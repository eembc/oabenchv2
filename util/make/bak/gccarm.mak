...
AS		= $(TOOLS)/bin/arm-linux-as

LD		= $(TOOLS)/bin/arm-linux-gcc
EXEOUT	= -o
EXE		= .exe

AR		= $(TOOLS)/bin/arm-linux-ar
LIBTYPE	= .a
LIBOUT	= 
...
COMPILER_FLAGS	= -O2    -mcpu=arm9tdmi $(CDEFN)NDEBUG $(AUTOCONF_DEFINES)
COMPILER_NOOPT	= -O0    -mcpu=arm9tdmi $(CDEFN)NDEBUG $(AUTOCONF_DEFINES)
COMPILER_DEBUG	= -O0 -g -mcpu=arm9tdmi $(AUTOCONF_DEFINES)
...
RUN				= $(TCDIR)/gdb.sh arm-linux-elf-gdb
endif
endif
