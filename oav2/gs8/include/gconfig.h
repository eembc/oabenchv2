...
#endif
#ifdef oper_
/*SG: for EE, no need for jbig, disable this define. oper_(zfjbig2_op_defs)*/
/*SG: for EE, no need for jbig, disable this define. oper_(zfjpx_op_defs)*/
#endif
#ifdef init_
...
/*SG: can't find this function. init_(gs_gsutil_init)*/
#endif
#ifdef image_type_
