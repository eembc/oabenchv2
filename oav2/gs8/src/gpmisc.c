...
/* $Id: gpmisc.c 6651 2006-03-13 16:18:19Z stefan $ */
/* Miscellaneous support for platform facilities */

/** ECL moved fcntl up to avoid conflicts with bit/types.h. */
#include "fcntl_.h"
#include "unistd_.h"
#include "stdio_.h"
#include "stat_.h"
...
{
/** ECL We don't want to do this embedded */
	return th_fopen(fname,mode);
#if 0
    int flags = O_EXCL;
