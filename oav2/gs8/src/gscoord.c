...
/* $Id: gscoord.c 6651 2006-03-13 16:18:19Z stefan $ */
...
/** ECL This uses an internal macro, that may not work with
simulator floating point packages. 
In this a 1 is turned into -3e+19.
*/
#ifndef	ROUND_CTM_FIXED
