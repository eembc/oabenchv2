...
#
# $Id: int.mak 6724 2006-04-27 17:39:56Z leonardo $
...
# ECL - add stub_autoconf
INT1=$(PSOBJ)stub_autoconf.$(OBJ) $(PSOBJ)iapi.$(OBJ) $(PSOBJ)icontext.$(OBJ) $(PSOBJ)idebug.$(OBJ)
...
# versions.
EXAMPLE_FILES=-P examples/ 3dcolor.ps Rotate-fontlist2.ps fractal-fern.ps spreadsheet.ps presentation.ps presentation4.pdf mandel.ps ebreadme.ps photo.ps banner.ps shadings.pdf
UTILITY_FILES=-P lib/ prfont.ps gsnup.ps landscap.ps stocht.ps viewcmyk.ps Fontmap.GS 
EXTRA_INIT_FILES= Fontmap cidfmap xlatmap FAPIcidfmap FAPIconfig FAPIfontmap $(EXAMPLE_FILES) $(UTILITY_FILES)
...
# ECL
$(PSOBJ)stub_autoconf.$(OBJ) : $(PSSRC)stub_autoconf.c
	$(PSCC) $(PSO_)stub_autoconf.$(OBJ) $(C_) $(PSSRC)stub_autoconf.c
