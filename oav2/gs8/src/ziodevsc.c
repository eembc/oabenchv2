...
/* $Id: ziodevsc.c 6651 2006-03-13 16:18:19Z stefan $ */
...
static const char iodev_dtype_stdio[] = "Special";
...
/* SG: multiple define with gsiodevs. For EE, make sure we use the define there. */
#ifdef GS_INTERNAL_BUILD
