...
/* $Id: ziodev.c 6651 2006-03-13 16:18:19Z stefan $ */
...
/* SG: use internal name to avoid linker issues */
const char iodev_dtype_stdio_zio[] = "Special";

/* Define the special devices. */
#define iodev_special(dname, init, open) {\
    dname, iodev_dtype_stdio_zio,\
