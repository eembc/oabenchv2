...
#
# $Id: zlib.mak 6651 2006-03-13 16:18:19Z stefan $
...
zlibd1_=$(ZOBJ)infblock.$(OBJ) $(ZOBJ)infcodes.$(OBJ) $(ZOBJ)inffast.$(OBJ) $(ZOBJ)infutil.$(OBJ) 
zlibd2_=$(ZOBJ)inflate.$(OBJ) $(ZOBJ)inftrees.$(OBJ) $(ZOBJ)infutil.$(OBJ) $(ZOBJ)crc32.$(OBJ)

# shorter list of files for zlib 1.2.x
zlibd_=$(ZOBJ)inffast.$(OBJ) $(ZOBJ)inflate.$(OBJ) $(ZOBJ)inftrees.$(OBJ) $(ZOBJ)uncompr.$(OBJ) $(ZOBJ)infutil.$(OBJ) $(ZOBJ)infblock.$(OBJ) $(ZOBJ)infcodes.$(OBJ)
