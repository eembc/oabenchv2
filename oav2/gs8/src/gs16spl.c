...
/* $Id: gs16spl.c 6651 2006-03-13 16:18:19Z stefan $ */
...
spoolfile(char *portname, char *filename)
{
	...
	SetWindowTextA(GetDlgItem(hwndspl, ID_TEXT), pcdone);
...
BOOL CALLBACK /*_export*/ SpoolDlgProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message) {
	case WM_INITDIALOG:
...
init_window(LPSTR cmdline)
{
    ...
    *d = '\0';
    ...
    hwndspl = CreateDialogA(phInstance, "SpoolDlgBox", HWND_DESKTOP, lpfnSpoolProc);
...
WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int cmdShow)
{
	...
	SetWindowTextA(GetDlgItem(hwndspl, ID_TEXT), error_message);
