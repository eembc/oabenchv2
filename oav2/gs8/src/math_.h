...
/* $Id: math_.h 6651 2006-03-13 16:18:19Z stefan $ */
...
/** ECL Add HAVE_HYPOT function to thconfig.h */
#if defined(_IBMR2) || defined(__CYGWIN__) || NEED_HYPOT
/* The RS/6000 has hypot, but math.h doesn't declare it! */
extern double hypot(double, double);
#elif defined(_MSC_VER)
#  define hypot(x,y) _hypot(x,y)
#elif !defined(__TURBOC__) && !defined(BSD4_2) && !defined(VMS) && !defined(__MWERKS__) && !HAVE_HYPOT
