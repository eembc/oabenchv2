...
/* $Id: gp_unifn.c 6651 2006-03-13 16:18:19Z stefan $ */
...
/** ECL
@warning To support c:/ paths, we must use ;, or the root length 
of the paths is miscalculated in file_path_add. This must also
be reflected in gconfig.h when defining LIBPATH.
*/
...
/** ECL
@warning On windows, use b as the lstat length will differ. 
On Unix, the b is a don't care. */
...
{
/** ECL 
Modified for Windows drive letters, compatible between MSVC and GCC.
Library Path searches with c:/ were returning c/.
*/
	int i=0;
