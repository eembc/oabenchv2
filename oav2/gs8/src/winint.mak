...
#
# $Id: winint.mak 6733 2006-05-10 21:44:14Z giles $
...
archive: zip $(PSOBJ)gswin16.ico $(ECHOGS_XE)
	...
	$(ECHOGS_XE) -w $(PSOBJ)about.txt "Artifex Ghostscript is Copyright " -x A9 " 2006 artofcode LLC."
	...
	$(ECHOGS_XE) -w $(PSOBJ)dialog.txt This installs Artifex Ghostscript $(GS_DOT_VERSION).
	$(ECHOGS_XE) -a $(PSOBJ)dialog.txt Artifex Ghostscript displays, prints and converts PostScript and PDF files.
