...
#define PNG_INTERNAL
#include "png.h"
#define malloc( size ) th_malloc_x( size, __FILE__, __LINE__ )
void *th_malloc_x( int size, const char *file, int line );
#define calloc( nmemb, size ) th_calloc_x( nmemb, size, __FILE__, __LINE__ )
void *th_calloc_x( int nmemb, int size, const char *file, int line );
#define realloc( blk, size ) th_realloc_x( blk, size, __FILE__, __LINE__ )
void *th_realloc_x( void *blk, int size, const char *file, int line );
#define free( blk ) th_free_x( blk, __FILE__, __LINE__ )
