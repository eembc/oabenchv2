/**
 * @file
 * @brief  Contains a generic, stand-alone printf engine
 *
 * $RCSfile: printfe.c,v $
 *
 ...
 *          $Author: rick $
 *          $Source: /usr/local/cvs/eembc2/th_lite/src/printfe.c,v $
 *
 *   @note 
 ...
 *
 * @note    This module handles 16bit integers efficiently.  It uses
 ...
 *          this way. (Well, strlen can be used, rlf.)
 *
 ...
 *
 * Revision 1.15  2005/12/02 23:53:35  rick
 * Fix mixed EOL format causing ^M's to appear in Unix checkouts.
 *
 * Revision 1.14  2005/09/10 04:02:24  rick
 * eol update, add uu_send_file
 *
 * Revision 1.13  2005/04/27 20:33:14  rick
 * Copyrite update 2005
 *
 * Revision 1.12  2004/12/08 23:27:18  rick
 * New standard header for documentation generation.
 *
 * Revision 1.18  2004/07/07 18:04:11  rick
 * Resolve type definition recursion on Linux GCC
 *
 * Revision 1.17  2004/06/23 05:55:23  rick
 * EE_REDIRECT, and Shared Files
 *
 * Revision 1.16  2004/03/15 21:29:06  rick
 * Add documentation tags, and cleanup comments
 *
 * Revision 1.15  2004/01/19 22:54:34  rick
 * Add CVS History section
 *
 *
 * @verbatim
 *------------------------------------------------------------------------------
